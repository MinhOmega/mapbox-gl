...
class GeolocateControl extends Evented {
    ...
    _setupUI(supported: boolean) {
        ...
        if (supported === false) {
            ...
            const title = this._map && this._map._getUIString ? this._map._getUIString('GeolocateControl.LocationNotAvailable') : 'Location Not Available';
            this._geolocateButton.disabled = true;
            this._geolocateButton.title = title;
            this._geolocateButton.setAttribute('aria-label', title);
        } else {
            const title = this._map && this._map._getUIString ? this._map._getUIString('GeolocateControl.FindMyLocation') : 'Find My Location';
            this._geolocateButton.title = title;
            this._geolocateButton.setAttribute('aria-label', title);
        }
